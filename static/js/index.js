...
function update(content) {
  ...
  $.ajax({
      url: '/timeline',
      data: JSON.stringify({txt:content, user_defined: CHARACTER.user_defined}),
      type: 'POST',
      ...
      success: function(res){
        ...
        CHARACTER.list_NER(res.entities)
...
$("#answer_questions").on("click", function(){
  var opt = confirm("Do you want to start answering the questions? You will have 20 minutes to answer 10 questions.")
